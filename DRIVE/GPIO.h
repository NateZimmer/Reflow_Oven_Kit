...
#define CHARGE_PUMP			P1_2
#define	CHARGE_PUMP_SETUP	P1DIR |=CHARGE_PUMP; P1SEL |=CHARGE_PUMP
#define CHARGE_PUMP_DESETUP	P1DIR &=~CHARGE_PUMP; P1SEL &=~CHARGE_PUMP
#define	CHARGE_PUMP_OUT		P1OUT &=~CHARGE_PUMP
#define CHARGE_PUMP_ON		CHARGE_PUMP_SETUP;
#define CHARGE_PUMP_OFF		CHARGE_PUMP_DESETUP;
